import { Clock, CheckCircle, XCircle, AlertCircle, Send, Users, Calendar, MessageCircle } from "lucide-react";
...
const statusConfig: Record<Status, StatusConfig> = {
  ...
  under_review: { icon: AlertCircle, color: "text-yellow-500", bg: "bg-yellow-50" },
  shortlisted: { icon: Users, color: "text-indigo-500", bg: "bg-indigo-50" },
  interview_scheduled: { icon: Calendar, color: "text-purple-500", bg: "bg-purple-50" },
  interview_completed: { icon: CheckCircle, color: "text-teal-500", bg: "bg-teal-50" },
  offer_pending: { icon: Clock, color: "text-orange-500", bg: "bg-orange-50" },
  offer_extended: { icon: MessageCircle, color: "text-blue-500", bg: "bg-blue-50" },
